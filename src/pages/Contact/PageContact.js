...
class PageContact extends Component {
  ...
  sendMail() {
    window.location.href = 'mailto:president@usiteam.org';
  }
                ...
                <Card className="border-0 text-center features feature-clean">
                  ...
                  <div className="content mt-3">
                    ...
                    <p className="text-muted">
                      Call us if you have any urgent questions
                    </p>
                    <Link
                      to="#"
              ...
              <Col md={5} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <Card className="border-0 text-center features feature-clean">
                  ...
                  <div className="content mt-3">
                    ...
                    <p className="text-muted">
                      Contact us if you have any questions about <br />
                      Texas Stock Pitch or USIT
                    </p>
                    <Link
                      to="#"
              ...
              <Col md={5} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <Card className="border-0 text-center features feature-clean">
                  ...
                  <div className="content mt-3">
                    ...
                    <p className="text-muted">
                      2201 Speedway, Austin, TX 78712 <br />
